...
final class Note extends Model implements HasCustomFields
{
    ...
    /**
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo<\App\Models\Custom\Projects, $this>
     */
    public function project(): \Illuminate\Database\Eloquent\Relations\BelongsTo
    {
        return $this->belongsTo(\App\Models\Custom\Projects::class, 'project_id');
    }
}
