...
class ListIdeas extends ListRecords
{
    ...
    public function getTable(): \Filament\Tables\Table
    {
        ...
        $userId = auth()->id();
        if ($userId) {
            $preferences = \Ofthewildfire\RelaticleModsPlugin\Models\UserTablePreferences::getPreferences($userId, 'ideas');
    ...
    protected function saveColumnOrderFromForm(array $formData): void
    {
        ...
        $existingPreferences = \Ofthewildfire\RelaticleModsPlugin\Models\UserTablePreferences::getPreferences($userId, 'ideas');
        ...
        \Ofthewildfire\RelaticleModsPlugin\Models\UserTablePreferences::savePreferences($userId, 'ideas', $existingPreferences);
