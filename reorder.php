...
class ListEvents extends ListRecords
{
    ...
    public function getTable(): \Filament\Tables\Table
    {
        ...
        $userId = auth()->id();
        if ($userId) {
            $preferences = \Ofthewildfire\RelaticleModsPlugin\Models\UserTablePreferences::getPreferences($userId, 'events');
    ...
    protected function saveColumnOrderFromForm(array $formData): void
    {
        ...
        $existingPreferences = \Ofthewildfire\RelaticleModsPlugin\Models\UserTablePreferences::getPreferences($userId, 'events');
        ...
        \Ofthewildfire\RelaticleModsPlugin\Models\UserTablePreferences::savePreferences($userId, 'events', $existingPreferences);
